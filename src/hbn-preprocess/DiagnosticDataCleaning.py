...
def data_clean(hbn_data_path: str) -> None:
    ...
    for i, n in itertools.product(range(0, len(df)), dx_ns):
        # if any of confirmed, presum, or RC are 1, if bybx is NULL,
        ...
        if all(
            [
                ...
                pd.isna(df.at[i, "Diagnosis_ClinicianConsensus,DX_" + n + "_Presum"]),
        ...
        # if confirmed and presum are NULL, and one of RC, Rule-Out or By History are 1,
